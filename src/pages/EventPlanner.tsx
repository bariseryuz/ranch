...
export default function EventPlanner() {
  usePageMeta({
    ...
    description:
      'Generate a recommended package outline for your corporate retreat, wedding, or private celebration.',
    keywords: 'ranch event planning, corporate retreat package',
  });
  ...
  return (
    <>
      <PageHero
        title="AI Event Planner"
        subtitle="Indicative packages · Connect pricing API later"
        image="https://images.unsplash.com/photo-1431540015161-246800ce7449?auto=format&fit=crop&q=80&w=2000"
        imageAlt="Planning"
      />
